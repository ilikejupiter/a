...
HOT_PACKAGES_2_DATA = [
    {
        ...
        "packages": [
            {
                "family_name": "Akrab",
                "family_code": "f4fd69c7-12a4-4047-a1f2-f4072a7c543e",
                "is_enterprise": False,
                "variant_name": "Akrab",
...
def show_hot_menu2():
    ...
    while in_bookmark_menu:
        ...
        # Gunakan data JSON langsung tanpa request
        hot_packages = HOT_PACKAGES_2_DATA
        ...
        if choice.isdigit() and 1 <= int(choice) <= len(hot_packages):
            ...
            for package in packages:
                package_detail = get_package_details(
                    api_key, tokens, package["family_code"], 
                    package["variant_name"], package["order"], 
